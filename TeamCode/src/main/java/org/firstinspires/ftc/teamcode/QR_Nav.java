...
public class QR_Nav extends LinearOpMode {
    ...
    String filePath = "F:\\Opulent_ProjectsDirectory_2015-2016\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\webapps\\AttendanceUsingQRCode\\QRCodes\\student3232_2015_12_15_10_29_46_123";
    ...
    public void runOpMode() {
        ...
        try {
            ...
            while (opModeIsActive()) {
                ...
                if (bmp != null) {
                    // webcamViewport.draw(process(bmp));
                    onNewFrame(bmp);
                }
                telemetry.update();
            }
    ...
    private Bitmap process(Bitmap bitmap) {
        ...
        try {
            ...
            for (int i = 0; i < sizeOfResultPoint - 1; i++) {
                canvas.drawLine(resultPoints[i].getX(), resultPoints[i].getY(), resultPoints[i+1].getX(), resultPoints[i+1].getY(), paint);
            }
